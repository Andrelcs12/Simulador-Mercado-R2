...
import { TrendingUp, Target, ShieldAlert, Smile, DollarSign } from "lucide-react";
...
export default function KPISection({ results, cashBalance }: KPISectionProps) {
  ...
  const items = [
    { label: "Resultado EBITDA", value: money(k.ebitda), sub: `Margem: ${ebitdaMargin.toFixed(1)}%`, icon: TrendingUp, color: "text-emerald-400" },
    { label: "Receita de Vendas", value: money(k.revenue), sub: "Base de Cesta Coletada", icon: Target, color: "text-orange-400" },
    { label: "Custo Operacional", value: money(k.expenses), sub: "Incluso CMV e Folha", icon: ShieldAlert, color: "text-rose-400" },
